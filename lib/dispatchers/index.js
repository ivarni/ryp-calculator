...
exports.onFinished = exports.labelChange = exports.fieldChange = exports.expandChange = undefined;
...
var onFinished = exports.onFinished = function onFinished(day, name) {
    return function (dispatch) {
        return dispatch(actions.exerciseFinished(day, name));
    };
};